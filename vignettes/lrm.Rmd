...
compare_result[, 3]
```
We see the the lrm() performs slower than glm(). It is reasonable because the IRLS coding in R. The runtime would improve the commented Rcpp code in the src file. You can also check https://github.com/y1zhong/LogisticRegRcpp for more reference.
